...
export class ClashConfigBuilder extends BaseConfigBuilder {
    ...
    formatConfig() {
        ...
        rules.push({ domain_suffix: ["aistudio.google.com"], domain_keyword: [], outbound: 'AI Services' })
        rules.push({ domain_suffix: ["openai.com"], domain_keyword: [], outbound: 'AI Services' })
        rules.push({ domain_suffix: ["chatgpt.com"], domain_keyword: [], outbound: 'AI Services' })
        rules.push({ domain_suffix: ["claudeusercontent.com"], domain_keyword: [], outbound: 'AI Services' })
        rules.push({ domain_suffix: ["forefront.ai"], domain_keyword: [], outbound: 'AI Services' })
        rules.push({ domain_suffix: ["claude.ai"], domain_keyword: [], outbound: 'AI Services' })
        rules.push({ domain_suffix: ["anthropic.com"], domain_keyword: [], outbound: 'AI Services' })
        rules.push({ domain_suffix: ["ai.com"], domain_keyword: [], outbound: 'AI Services' })
        rules.push({ domain_suffix: ["bard.google.com"], domain_keyword: [], outbound: 'AI Services' })
        rules.push({ domain_suffix: ["generativelanguage.googleapis.com"], domain_keyword: [], outbound: 'AI Services' })
        rules.push({ domain_suffix: ["googleapis.com"], domain_keyword: [], outbound: 'AI Services' })
        rules.push({ domain_suffix: ["apple-retry.apple.com"], domain_keyword: [], outbound: 'AI Services' })

        rules.push({ domain_suffix: ["sellercentral.amazon.com"], domain_keyword: [], outbound: 'Fall Back' })
        rules.push({ domain_suffix: ["amazon.com"], domain_keyword: [], outbound: 'Fall Back' })
